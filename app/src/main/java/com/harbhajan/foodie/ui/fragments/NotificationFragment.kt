...
import com.harbhajan.foodie.adapters.RecyclerNotificationAdapter
...
class NotificationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val url ="https://admin.manadelivery.in/admin/restaurant_assigned/"
        urlId="?rid=$resId"
            ...
            object : JsonObjectRequest(Method.GET, url +urlId, null, Response.Listener {
                try {
                    ...
                    for (i in 0 until data.length()) {
                        ...
                        recyclerAdapter=
                            RecyclerNotificationAdapter(activity as Context,notificationDetails)
