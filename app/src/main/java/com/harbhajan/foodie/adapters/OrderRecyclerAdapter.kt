...
import com.harbhajan.foodie.ui.activities.OrderHistoryActivity
import com.harbhajan.foodie.modals.Orders
import com.harbhajan.foodie.R

class OrderRecyclerAdapter(val context: Context, private val orderList: ArrayList<Orders>):
    RecyclerView.Adapter<OrderRecyclerAdapter.HomeViewHolder>() {
